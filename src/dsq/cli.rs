...
/// dsq - A data processing tool that extends jq for structured data formats
///
/// dsq brings the power of jq's intuitive filter language to structured data formats
/// like CSV, Parquet, JSON, and more. It leverages Polars DataFrames for high-performance
/// data manipulation while maintaining compatibility with jq syntax.
#[derive(Parser, Debug)]
#[command(name = "dsq")]
...
impl From<&Cli> for CliConfig {
    fn from(cli: &Cli) -> Self {
        ...
        eprintln!("DEBUG: CliConfig limit: {:?}", config.limit);
