...
mod tests {
    ...
    fn test_sum_mean_with_nulls_and_mixed_types() {
        ...
        // All nulls
        let n1 = Value::Object(HashMap::from([("value".to_string(), Value::Null)]));
        let n2 = Value::Object(HashMap::from([("value".to_string(), Value::Null)]));
        let null_items = vec![&n1, &n2];
    ...
    fn test_min_max_with_different_types() {
        let i1 = Value::Object(HashMap::from([("int_val".to_string(), Value::Int(10))]));
        let i2 = Value::Object(HashMap::from([("int_val".to_string(), Value::Int(5))]));
        let f1 = Value::Object(HashMap::from([(
            "float_val".to_string(),
            Value::Float(7.5),
        )]));
        let f2 = Value::Object(HashMap::from([(
            "float_val".to_string(),
            Value::Float(12.3),
        )]));
        let s1 = Value::Object(HashMap::from([(
            "str_val".to_string(),
            Value::String("apple".to_string()),
        )]));
        let s2 = Value::Object(HashMap::from([(
            "str_val".to_string(),
            Value::String("banana".to_string()),
        )]));
        let items = vec![&i1, &i2, &f1, &f2, &s1, &s2];
